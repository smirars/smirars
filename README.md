...
## :bust_in_silhouette: Обо мне:
   В данный момент обучающий в МТУСИ по направлению "Фундаментальная информатика и информационные технологии". С недавнего времени увлекаюсь фронтенд-разработкой.
...
- Pixel Perfect
- Кроссбраузерная и адаптивная вёрста
- Манипулирование DOM
